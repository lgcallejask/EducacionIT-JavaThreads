...
public class Chat extends javax.swing.JFrame {
    public Chat() {
        ...
        //        .getMap()
        //        .keySet()
        //        .forEach(item->{cmbLista.addItem(item);});
        
        MapaDirecciones.getMap().keySet().forEach(cmbLista::addItem);
        
        //usando forEach
        //Set<String>keys=MapaDirecciones.getMap().keySet();
        //for(String st:keys) cmbLista.addItem(st);
        
        //Encender servicio de chat
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        // Evento Enviar
        String ip=MapaDirecciones.getMap().get(cmbLista.getSelectedItem()+"");
        String mensaje=txtMensaje.getText();
        try(
           Socket so=new Socket(ip,7000);
